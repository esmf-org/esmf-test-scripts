...
cd /home/himanshu/esmf-org.github.io/test_results
rm *.html
rm -r *_tests

cp /project/esmf/regression_test/2week_results/trunk_results_noheader/*.shtml .
...
for i in benchmrk.html doc_build.html index.html netcdf.html pio.html proj4.html test_builds.html bfb.html esmpy.html mapl.html nuopc.html platform_sort.html python.html use_test_cases.html compiler_sort.html external_demos.html mem_leak.html ocgis.html pnetcdf.html releases.html yaml.html 
do
	sed 's/.shtml/.html/g' $i > x1.html
	sed 's;developers/test/daily/2week_results/trunk_results_noheader;test_results;g' x1.html > x2.html
...
git add . 
git commit -m " Build regression test results `date` "
