...
#python3 ./esmf-test-scripts/python_scripts/test_esmf.py -y  ./esmf-test-scripts/gaea.yaml -a /lustre/f2/dev/Mark.Potts/esmf-test-artifacts >& /lustre/f2/dev/Mark.Potts/esmf-test-scripts/gaea.log
