...
cat /project/esmf/himanshu/ESMF-Testing-PGI/LOGDIR/Test_Status >> meta_data_izumi_pgi_mpiuni.log

echo "Test_Failures :" `cat /project/esmf/himanshu/ESMF-Testing-PGI/LOGDIR/Test_Failures` >> meta_data_izumi_pgi_mpiuni.log
#echo "Test_Failures :" `cat /project/esmf/himanshu/ESMF-Testing-PGI/openmpi/LOGDIR/Test_Failures` >> meta_data_izumi_pgi_openmpi.log
echo "Test_artifacts made at" `date` >> meta_data_izumi_pgi_mpiuni.log
#echo "Test_artifacts made at" `date` >> meta_data_izumi_pgi_openmpi.log
...
cp -rf /project/esmf/himanshu/storage/develop/g_outputfiles/build_Linux*pgimpiuni_g.out build.out
...
cp -rf /project/esmf/himanshu/storage/develop/g_outputfiles/install_Linux*pgimpiuni_g.out install.out
...
cp -rf /project/esmf/himanshu/storage/develop/g_outputfiles/run_unit_tests_Linux*pgimpiuni_g.out run_unit_tests.out
...
cp -rf /project/esmf/himanshu/storage/develop/O_outputfiles/build_Linux*pgimpiuni_O.out build.out
...
cp -rf /project/esmf/himanshu/storage/develop/O_outputfiles/install_Linux*pgimpiuni_O.out install.out
...
cp -rf /project/esmf/himanshu/storage/develop/O_outputfiles/run_unit_tests_Linux*pgimpiuni_O.out run_unit_tests.out
...
#cp -rf /project/esmf/himanshu/storage/develop/g_outputfiles/build_Linux*pgiopenmpi_g.out build.out
...
#cp -rf /project/esmf/himanshu/storage/develop/g_outputfiles/install_Linux*pgiopenmpi_g.out install.out
...
#cp -rf /project/esmf/himanshu/storage/develop/g_outputfiles/run_unit_tests_Linux*pgiopenmpi_g.out run_unit_tests.out
...
#cp -rf /project/esmf/himanshu/storage/develop/O_outputfiles/build_Linux*pgiopenmpi_O.out build.out
...
#cp -rf /project/esmf/himanshu/storage/develop/O_outputfiles/install_Linux*pgiopenmpi_O.out install.out
...
#cp -rf /project/esmf/himanshu/storage/develop/O_outputfiles/run_unit_tests_Linux*pgiopenmpi_O.out run_unit_tests.out
...
touch a.sh
git rm *.log
cp -rf /project/esmf/himanshu/storage/develop/meta_data_izumi_pgi_mpiuni.log summary.log
rm a.sh
...
git rm *.html
git rm commit.log
cp -rf /project/esmf/himanshu/ESMF-Testing-PGI/LOGDIR/newMailMessage result.html
#cp -rf /project/esmf/himanshu/ESMF-Testing-PGI/openmpi/LOGDIR/newMailMessage Izumi_PGI_openmpi.html
sed -i '1i<pre>' result.html
#sed -i '1i<pre>' Izumi_PGI_openmpi.html
rm a.sh
...
cd /project/esmf/himanshu/storage/esmf-test-artifacts/
git add .
git commit -m " Izumi PGI commit log pushed at `date` [ci skip] "
#git commit -m " Izumi PGI commit log pushed at Mon Dec 14 23:05:34 MST 2020"
