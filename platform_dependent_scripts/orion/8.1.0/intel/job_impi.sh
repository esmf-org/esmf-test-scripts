...
#SBATCH --job-name=himanshu_intel
#SBATCH --output=intel.out
#SBATCH --error=intel.err
#SBATCH --account=nems
#SBATCH --time=06:00:00
#SBATCH -N 1
#SBATCH -n 12

cd /home/hpillai/esmf_test/intel
...
export ver=$(icpc -dumpversion)
echo "version of intel ${ver}"
...
#export ESMF_MPIRUN=/apps/intel-2020/intel-2020/compilers_and_libraries_2020.0.166/linux/mpi/intel64/bin/mpirun
...
echo "RUN: [$RUN]"
	...
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                       	 ...
                       	 srun ./ESMF_Regrid --help 1> ESMF_Regrid.stdout  2>&1
	...
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                   ...
                   srun ./ESMF_Regrid --version 1> ESMF_Regrid.stdout  2>&1
	...
	echo "" >> $LOGDIR/mailMessage
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                      srun ./ESMF_Regrid -V 1> ESMF_Regrid.stdout  2>&1
                if [ "$?" != "0" ]
                then
                        echo "ESMF_Regrid FAILED with ESMF_BOPT=$OPT"
	...
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                 ...
                 srun ./ESMF_PrintInfo --help  1> ESMF_PrintInfo.stdout  2>&1
                if [ "$?" != "0" ]
                then
	...
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                         ...
                         srun ./ESMF_PrintInfo --version  1> ESMF_PrintInfo.stdout  2>&1
	...
	echo "" >> $LOGDIR/mailMessage
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                 srun ./ESMF_PrintInfo -V  1> ESMF_PrintInfo.stdout  2>&1
                if [ "$?" != "0" ]
                then
                        echo "ESMF_PrintInfo FAILED with ESMF_BOPT=$OPT"
	...
	echo "" >> $LOGDIR/mailMessage
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                  srun ./ESMF_PrintInfoC --help  1> ESMF_PrintInfoC.stdout  2>&1
                if [ "$?" != "0" ]
                then
	...
	echo "" >> $LOGDIR/mailMessage
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                 srun ./ESMF_PrintInfoC --version  1> ESMF_PrintInfoC.stdout  2>&1
	...
	echo "" >> $LOGDIR/mailMessage
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                 srun ./ESMF_PrintInfoC -V  1> ESMF_PrintInfoC.stdout  2>&1
	...
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                 ...
                 srun ./ESMF_RegridWeightGen --help  1> ESMF_RegridWeightGen.stdout  2>&1
	...
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                 ...
                 srun ./ESMF_RegridWeightGen --version  1> ESMF_RegridWeightGen.stdout  2>&1
	...
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                 ...
                 srun ./ESMF_RegridWeightGen -V  1> ESMF_RegridWeightGen.stdout  2>&1
	...
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                 ...
                 srun ./ESMF_Scrip2Unstruct --help  1> ESMF_Scrip2Unstruct.stdout  2>&1
	...
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                 ...
                 srun ./ESMF_Scrip2Unstruct --version  1> ESMF_Scrip2Unstruct.stdout  2>&1
	...
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                 ...
                 srun ./ESMF_Scrip2Unstruct -V  1> ESMF_Scrip2Unstruct.stdout  2>&1
...
mail -s "ESMF_Trunk_Orion_intel" himanshu@ucar.edu < $LOGDIR/newMailMessage
