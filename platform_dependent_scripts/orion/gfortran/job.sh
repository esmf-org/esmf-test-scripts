...
#SBATCH --job-name=himanshu_gfortran
...
cd /home/hpillai/esmf_test/gfortran
...
mail -s "ESMF_Trunk_Orion_gfortran" himanshu@ucar.edu < $LOGDIR/newMailMessage
