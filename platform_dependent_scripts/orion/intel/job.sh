...
echo "RUN: [$RUN]"
	...
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                 ...
                 srun ./ESMF_Info --help  1> ESMF_Info.stdout  2>&1
                if [ "$?" != "0" ]
                then
	...
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                         ...
                         srun ./ESMF_Info --version  1> ESMF_Info.stdout  2>&1
	...
	echo "" >> $LOGDIR/mailMessage
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                 srun ./ESMF_Info -V  1> ESMF_Info.stdout  2>&1
                if [ "$?" != "0" ]
                then
                        echo "ESMF_Info FAILED with ESMF_BOPT=$OPT"
	...
	echo "" >> $LOGDIR/mailMessage
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                  srun ./ESMF_InfoC --help  1> ESMF_InfoC.stdout  2>&1
                if [ "$?" != "0" ]
                then
	...
	echo "" >> $LOGDIR/mailMessage
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                 srun ./ESMF_InfoC --version  1> ESMF_InfoC.stdout  2>&1
	...
	echo "" >> $LOGDIR/mailMessage
	echo "|--------------------------------------------------------------|" >> $LOGDIR/mailMessage
                 srun ./ESMF_InfoC -V  1> ESMF_InfoC.stdout  2>&1
