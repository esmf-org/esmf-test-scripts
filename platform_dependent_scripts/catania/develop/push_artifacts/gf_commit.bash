...
git rm *.html
git rm commit.log
cp -rf /project/esmf/himanshu/esmf_test/cronjobs/daily/gfortran/dir/esmf_logs/2102_test/ESMFdailyLog result.html
...
cd /project/esmf/himanshu/storage/esmf-test-artifacts/develop/catania/gfortran/
git log --since=6.days --grep='Catania GFortran commit log' >  commit.log

cd /project/esmf/himanshu/storage/esmf-test-artifacts/
git add .
git commit -m " Catania GFortran commit log pushed at `date` [ci skip] "
