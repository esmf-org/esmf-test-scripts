...
git rm result.html
git rm commit.log
cp -rf /project/esmf/himanshu/esmf_test/cronjobs/daily/intel/esmf_logs/2102_test/ESMFdailyLog result.html
...
cd /project/esmf/himanshu/storage/esmf-test-artifacts/
git add .
git commit -m " Catania Intel commit log pushed at `date` [ci skip] "
