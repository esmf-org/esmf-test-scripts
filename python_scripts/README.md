...
Use the following steps to start with a fresh esmf-test-artifacts:
  ...
  4. Under Settings/Collaborators-and-teams, in section "Manage access", explicitly add `mark-a-potts` and `mathomp4` with role "write". Without this, Mark's and Matt's scripts cannot push to the new artifacts repo!
