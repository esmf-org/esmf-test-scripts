...
PREFIX=/scratch1/NCEPDEV/stmp2/Rocky.Dunlap/piofix/PIO-INSTALL

# Set source of hpc-stack repository
HPC_STACK_ROOT=/scratch1/NCEPDEV/stmp2/Rocky.Dunlap/piofix/hpc-stack
...
# Build and install
$HPC_STACK_ROOT/libs/build_pio.sh
